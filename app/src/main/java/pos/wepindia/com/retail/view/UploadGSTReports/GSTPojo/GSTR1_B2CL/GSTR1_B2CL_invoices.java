package pos.wepindia.com.retail.view.UploadGSTReports.GSTPojo.GSTR1_B2CL;
...
public class GSTR1_B2CL_invoices {
    ...
    public GSTR1_B2CL_invoices(String cname, String inum, String idt, double val, String pos, String prs, String od_num, String od_dt, String etin, ArrayList<GSTR1_B2CL_items> itms) {
        this.cname = cname;
        this.inum = inum;
        this.idt = idt;
        this.val = val;
