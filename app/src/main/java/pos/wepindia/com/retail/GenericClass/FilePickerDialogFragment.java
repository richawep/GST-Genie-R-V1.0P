...
import pos.wepindia.com.retail.view.ItemMasters.ItemMasterAddItemDialogFragment;
import pos.wepindia.com.retail.view.ItemMasters.ItemMasterEditItemDialogFragment;
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        try {
            ...
            if(newFile.isFile())
            {
                ...
                Logger.v("FilePickerActivity", "File Extension:" + strExtension);
                ...
                String ItemMastersFragmentName = ItemMastersFragment.class.getSimpleName();
