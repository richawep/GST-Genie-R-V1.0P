...
import pos.wepindia.com.retail.view.UploadGSTReports.GSTPojo.GSTR1_CDN.GSTR1_CDN_Items;
import pos.wepindia.com.retail.view.UploadGSTReports.GSTPojo.GSTR1_CDN.GSTR1_CDN_Items_details;
import pos.wepindia.com.retail.view.UploadGSTReports.GSTPojo.GSTR1_DocDetails.GSTR1_DOCS;
import pos.wepindia.com.retail.view.UploadGSTReports.GSTPojo.GSTR1_DocDetails.GSTR1_DOCS_Data;
...
public class GSTUploadFunctions {
                    ...
                    do {
                        ...
                        if(item_list!=null && item_list.size()>0) {
                            try {
                                ...
                                if(rchrg==null || rchrg.equalsIgnoreCase("0"))
                                    rchrg = "N";
                                else
                                    rchrg = "Y";
                                if(prs==null)
   ...
   /* private ArrayList<GSTR1_B2CS_A_Data> makeGSTR1B2CSA(String start_milli, String end_milli){
    ...
    public ArrayList<GSTR1_B2CS_Data> makeGSTR1B2CS(String start_milli, String end_milli)
    {
                        ...
                        if (rowcursor == null) {
                            ...
                            try {
                                ...
                                while (rowcursor.moveToNext()) {
                                    ...
                                    subtotal_f = Double.parseDouble(rowcursor.getString(rowcursor.getColumnIndex("TaxableValue")));
    ...
    public ArrayList<GSTR1_HSN_Data> getGSTR1HSNData(String startDate, String endDate) {
        ...
        try {
            while (cursor_invoices_outward!=null && cursor_invoices_outward.moveToNext())
            {
                ...
                Cursor cursor_itemLedger = dbReport.getItemsFromBillItem_new(invNo,invDt);
