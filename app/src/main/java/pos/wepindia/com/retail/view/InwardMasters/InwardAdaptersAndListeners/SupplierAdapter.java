...
public class SupplierAdapter extends BaseAdapter {
    ...
    public SupplierAdapter(Context activityContext, ArrayList<Supplier_Model> supplierList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       SupplierAdapter.ViewHolder viewHolder;
        if(convertView == null)
        {
            ...
            viewHolder.imgBtnDelete.setBackground(activityContext.getResources().getDrawable(R.mipmap.ic_delete));
                    ...
                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            for(Supplier_Model supplier : SupplierList)
                            {
                                ...
                                {
                                    long ll = HomeActivity.dbHandler.deleteSupplier(SupplierCode);
                                    if(ll >0)
                                    {
                                      ...
                                      /*  if(activityName.equalsIgnoreCase("com.wepindia.pos.SupplierDetailsActivity"))
                                        {
                                            ( activityContext).loadAutoCompleteSupplierName();
                                       ...
                                       /* long del = HomeActivity.dbHandler.DeleteSupplierItems_suppliercode(SupplierCode);
                                        if(del > 0)
