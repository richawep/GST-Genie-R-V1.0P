...
import pos.wepindia.com.wepbase.model.print.BillSubTaxItem;
...
import pos.wepindia.com.wepbase.model.print.PrintIngredientsModel;
    ...
    public String getPrintBill(PrintKotBillItem item) {
       ...
       /* esc.addText("Date            : "+item.getDate() +"\n");
        ...
        if (!item.getSalesManId().equals("") && !item.getSalesManId().contains("-")) {
            esc.addText("Salesman Id     : "+item.getSalesManId()+"\n");
        }
