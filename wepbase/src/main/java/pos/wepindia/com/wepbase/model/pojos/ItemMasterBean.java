...
public class ItemMasterBean implements Parcelable {
    ...
    int _id, iShortCode, iBrandCode, iCategoryCode, iDeptCode, isFav, isActive, iMode;
    String strShortName, strLongName, strBarcode, strSupplyType, strUOM, strHSNCode,
            strImageUri;
    double dblRetailPrice, dblMRP, dblWholeSalePrice, dblQty, dbDiscountPer,
            dblDiscountAmt, dblCGSTRate, dblSGSTRate, dblIGSTRate, dblCessRate;
